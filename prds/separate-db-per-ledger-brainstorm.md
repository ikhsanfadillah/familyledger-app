...
Berikut adalah brainstorming, analisis kelebihan, dan kelemahan dari arsitektur _Multiple Databases_ dibandingkan dengan arsitektur _Single Database_ yang kita pakai sekarang.
...
Karena kita sudah menggunakan **Yjs per Ledger (`y-webrtc`)** dan **Enkripsi Master Key**, arsitektur **Multiple Databases** sebenarnya sangat _make sense_.
