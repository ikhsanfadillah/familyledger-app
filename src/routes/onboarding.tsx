...
import { createUser, saveCategories } from "~/db/queries";
...
function OnboardingPage() {
  ...
  return (
    <div class="min-h-[100dvh] bg-gray-50 flex flex-col justify-center items-center px-4 sm:px-6 py-6 sm:py-10">
      <div class="max-w-md w-full bg-white p-6 sm:p-8 rounded-3xl shadow-xl shadow-blue-500/5 relative overflow-hidden flex flex-col">
        ...
        {/* STEP 1: Introduction */}
        <Show when={currentStep() === 1}>
          <div class="flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <h1 class="text-3xl font-extrabold text-gray-900 mb-4 tracking-tight">
              ...
              <span class="text-blue-500">FamilyLedger</span>
            </h1>
            <p class="text-base text-gray-500 mb-10 leading-relaxed max-w-[280px] mx-auto">
            ...
            <Button
              ...
              class="w-full h-14 rounded-2xl bg-blue-500 hover:bg-blue-600 text-white font-semibold text-lg transition-transform active:scale-[0.98]"
            >
              Mulai Sekarang
            </Button>
          </div>
        ...
        <Show when={currentStep() === 2}>
          <div class="animate-in fade-in slide-in-from-right-4 duration-500 flex-1 flex flex-col">
            ...
            <div class="space-y-6 flex-1">
              <div class="flex flex-col gap-2">
                ...
                <input
                  ...
                  class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 outline-none transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 placeholder:text-gray-400 text-gray-900"
                />
              </div>
            ...
            <div class="flex gap-4 mt-10">
              <Button
                ...
                class="flex-1 h-14 rounded-2xl font-semibold text-lg"
              >
                Kembali
              </Button>
              <Button
                ...
                onClick={goToNextStep}
                class="flex-1 h-14 rounded-2xl bg-blue-500 text-white font-semibold text-lg"
              >
                Lanjutkan
              </Button>
            </div>
